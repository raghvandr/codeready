...
$this->title = 'Cloud';
?>
<body  class="" data-bs-spy="scroll" data-bs-target="#navmenu" data-aos-easing="ease-in-out" data-aos-duration="600" data-aos-delay="0">
...
<!-- <section id="CloudServices" class="" style="padding-top: 0px;padding-bottom: 0px;"> -->
...
<!--  Section - Home Page -->
<section id="" class="features">
  <div class="container-fluid " style="background-color:#042315;padding-top: 65px;padding-bottom: 60px;" data-aos="fade-up">
    <div class="row gy-4">
...
<div class="row gy-4 align-items-stretch justify-content-between features-item ">
    <div class="col-lg-5 d-flex justify-content-center flex-column" data-aos="fade-up" >
      <h1 class="display-6 fs-title-lg-bold aos-init aos-animate  text-justify text-danger" data-column="intro_title" data-aos="fade-up" >Get a 30-minute, no-cost strategy session with a Cloud Services expert </h1>
      <p class="text-justify">Whether you are looking to develop a strategy, migrating to Cloud, obtain managed services, or further modernize and secure your applications and infrastructure, request an expert consultation at no cost.</p>
      <!-- <a href="#" class="btn rounded-pill btn-get-started align-self-start">Explore Cloud Consulting <i class="bi bi-arrow-right-circle"></i></a> -->
      <a href="#" class="">
        <button type="button" class="btn btn-outline-danger">Lets Talk
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"></path>
          </svg>
        </button>
